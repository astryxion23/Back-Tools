...
public final class EventHandler
{
	...
	public static HashSet<ResourceLocation> enabledToolItemIds = new HashSet<>();
	...
	public static HashMap<ResourceLocation, Integer> toolItemOrientations = new HashMap<>();
	...
	public static void registerFabricEvents()
	{
		...
		ClientWorldEvents.AFTER_CLIENT_WORLD_CHANGE.register((client, world) -> client.execute(EventHandler::clean));
